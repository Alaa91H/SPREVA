...
- Academic German curriculum A1 → C1: **complete** — 73 units, 292 lessons,
  3,267 activities, German/Arabic/English instructional content, and curriculum integrity validation
...
- **Content-as-data** — bundled JSON course; complete A1–C1 academic path (292 lessons / 3,267 activities), parser + curriculum/media integrity gates; downloadable packages later
